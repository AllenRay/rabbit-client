...
import com.oneplus.common.rabbit.ConsumerHandler;
...
public class HandlerService implements ApplicationContextAware,EmbeddedValueResolverAware {
    ...
    private final Logger logger = LoggerFactory.getLogger(com.oneplus.common.rabbit.handler.HandlerService.class);

    private Map<String, com.oneplus.common.rabbit.handler.Handler> handlerMap = new HashMap<>();
    ...
    public void initHandlerMap(){
        ...
        Map<String, com.oneplus.common.rabbit.handler.Handler> map = BeanFactoryUtils.beansOfTypeIncludingAncestors(context, com.oneplus.common.rabbit.handler.Handler.class, true, false);

        if(map != null && !map.isEmpty()) {
            for (com.oneplus.common.rabbit.handler.Handler handler : map.values()) {
                //根据注解去匹配是producer handler 还是 consumer handler
                com.oneplus.common.rabbit.ProducerHandler producerHandler = AnnotationUtils.findAnnotation(handler.getClass(), com.oneplus.common.rabbit.ProducerHandler.class);
                if (producerHandler != null) {
                    ...
                    com.oneplus.common.rabbit.ConsumerHandler consumerHandler = AnnotationUtils.findAnnotation(handler.getClass(), ConsumerHandler.class);
     ...
     * @return
     */
    public com.oneplus.common.rabbit.handler.Handler getProducerHandler(String exchange,String routingKey){
