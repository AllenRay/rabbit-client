...
import com.oneplus.common.rabbit.consumer.OneplusSimpleMessageConsumer;
import com.oneplus.common.rabbit.exception.RabbitChannelException;
import com.oneplus.common.rabbit.exception.RabbitConnectionException;
...
import com.oneplus.common.rabbit.messageConverter.hessian.HessianMessageConverter;
import com.oneplus.common.rabbit.sender.OneplusSimpleMessageSender;
...
public class RabbitTemplate{
     ...
     */
    public void sendMessage(com.oneplus.common.rabbit.Message message,MessageChannelCallback messageChannelCallback){
     ...
     * @param message
     */
    public void sendMessage(com.oneplus.common.rabbit.Message message){
     ...
     * @param routingKey
     */
    public void sendMessage(com.oneplus.common.rabbit.Message message,String exchange,String routingKey){
     ...
     * @param exchange
     */
    public void sendMessage(com.oneplus.common.rabbit.Message message,String exchange){
     ...
     */
    public void sendMessage(final com.oneplus.common.rabbit.Message message, final String exchange, final String routingKey,AMQP.BasicProperties basicProperties){
        Assert.notNull(message);
        Assert.notNull(exchange);

        Channel channel = channelFactory.getChannel();
        try{
            OneplusSimpleMessageSender simepleMessageSender = new OneplusSimpleMessageSender(getMessageConverter(),channel,handlerService);
     ...
     * @param basicProperties
     */
    public void sendMultiMessage(List<com.oneplus.common.rabbit.Message> messages,String exchange,String routingKey,AMQP.BasicProperties basicProperties){
     ...
     * @param routingKey
     */
    public void  sendMultiMessage(List<com.oneplus.common.rabbit.Message> messages,String exchange,String routingKey){
     ...
     * @param exchange
     */
    public void  sendMultiMessage(List<com.oneplus.common.rabbit.Message> messages,String exchange){
    ...
    private void consuming(final String queue, int fetchCount, final Channel channel) throws IOException {
        ...
        channel.basicConsume(queue,false,new OneplusSimpleMessageConsumer(channel,handlerService,getMessageConverter(),queue));
    }
    ...
    public void postInitAndCheck(){
        if(channelFactory == null){
            throw new RabbitConnectionException("Has no com.oneplus.common.rabbit connection channelFactory.");
        }
