...
public class QueueDeclare {
    ...
    private final Logger logger = LoggerFactory.getLogger(com.oneplus.common.rabbit.QueueDeclare.class);
    ...
    private com.oneplus.common.rabbit.ChannelFactory channelFactory;
    ...
    public com.oneplus.common.rabbit.ChannelFactory getChannelFactory() {
