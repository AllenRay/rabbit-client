package com.oneplus.common.rabbit.messageConverter.hessian;
...
public class HessianMessageConverter implements MessageConverter,Serializable {
    ...
    private final Logger logger = LoggerFactory.getLogger(com.oneplus.common.rabbit.messageConverter.hessian.HessianMessageConverter.class);
