...
import com.oneplus.common.rabbit.lyra.config.ConfigurableChannel;
import com.oneplus.common.rabbit.lyra.config.ConnectionConfig;
import com.oneplus.common.rabbit.lyra.event.ChannelListener;
import com.oneplus.common.rabbit.lyra.event.ConnectionListener;
import com.oneplus.common.rabbit.lyra.internal.util.*;
import com.oneplus.common.rabbit.lyra.internal.util.concurrent.NamedThreadFactory;
...
public class ConnectionHandler extends RetryableResource implements InvocationHandler {
  ...
  final Map<String, ResourceDeclaration> exchangeDeclarations = com.oneplus.common.rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
  final ArrayListMultiMap<String, Binding> exchangeBindings = com.oneplus.common.rabbit.lyra.internal.util.Collections.arrayListMultiMap();
  final Map<String, QueueDeclaration> queueDeclarations = com.oneplus.common.rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
  final ArrayListMultiMap<String, Binding> queueBindings = com.oneplus.common.rabbit.lyra.internal.util.Collections.arrayListMultiMap();
