package cn.rabbit.messageConverter.hessian;

import cn.rabbit.exception.RabbitMessageReceiveException;
...
public class HessianMessageConverter implements MessageConverter,Serializable {
    ...
    private final Logger logger = LoggerFactory.getLogger(HessianMessageConverter.class);
