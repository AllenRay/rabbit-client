...
import rabbit.lyra.config.ChannelConfig;
import rabbit.lyra.config.Config;
import rabbit.lyra.event.ChannelListener;
import rabbit.lyra.event.ConsumerListener;
...
public class ChannelHandler extends RetryableResource implements InvocationHandler {
    ...
    // Delegate state
    final Map<String, ConsumerDeclaration> consumerDeclarations = rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
