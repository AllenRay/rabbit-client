package rabbit.lyra.internal;

import rabbit.lyra.ConnectionOptions;
import rabbit.lyra.config.Config;
import rabbit.lyra.config.ConfigurableChannel;
import rabbit.lyra.config.ConnectionConfig;
import rabbit.lyra.event.ChannelListener;
import rabbit.lyra.event.ConnectionListener;
import rabbit.lyra.internal.util.*;
import rabbit.lyra.internal.util.concurrent.NamedThreadFactory;
...
public class ConnectionHandler extends RetryableResource implements InvocationHandler {
    ...
    final Map<String, ResourceDeclaration> exchangeDeclarations = rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
    final ArrayListMultiMap<String, Binding> exchangeBindings = rabbit.lyra.internal.util.Collections.arrayListMultiMap();
    final Map<String, QueueDeclaration> queueDeclarations = rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
    final ArrayListMultiMap<String, Binding> queueBindings = rabbit.lyra.internal.util.Collections.arrayListMultiMap();
