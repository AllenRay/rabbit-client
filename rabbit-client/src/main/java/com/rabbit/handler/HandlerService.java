...
import com.rabbit.ConsumerHandler;
        ...
        if(map != null && !map.isEmpty()) {
            for (Handler handler : map.values()) {
                //根据注解去匹配是producer handler 还是 consumer handler
                 com.rabbit.ProducerHandler producerHandler = AnnotationUtils.findAnnotation(handler.getClass(), com.rabbit.ProducerHandler.class);
                if (producerHandler != null) {
                    ...
                    this.handlerMap.put(key, handler);
                     ...
                     com.rabbit.ConsumerHandler consumerHandler = AnnotationUtils.findAnnotation(handler.getClass(), ConsumerHandler.class);
