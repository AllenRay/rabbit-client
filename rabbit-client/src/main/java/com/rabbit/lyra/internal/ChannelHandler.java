...
import com.rabbit.lyra.config.ChannelConfig;
...
import com.rabbit.lyra.internal.util.*;
...
public class ChannelHandler extends RetryableResource implements InvocationHandler {
  ...
  // Delegate state
  final Map<String, ConsumerDeclaration> consumerDeclarations = com.rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
