...
import com.oneplus.common.rabbit.ProducerHandler;
        ...
        if(map != null && !map.isEmpty()) {
            for (Handler handler : map.values()) {
                //根据注解去匹配是producer handler 还是 consumer handler
                 com.oneplus.common.rabbit.ProducerHandler producerHandler = AnnotationUtils.findAnnotation(handler.getClass(), ProducerHandler.class);
                if (producerHandler != null) {
                    ...
                    this.handlerMap.put(key, handler);
                     ...
                     ConsumerHandler consumerHandler = AnnotationUtils.findAnnotation(handler.getClass(), ConsumerHandler.class);
