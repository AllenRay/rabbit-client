...
import com.oneplus.common.rabbit.lyra.config.ChannelConfig;
import com.oneplus.common.rabbit.lyra.config.Config;
import com.oneplus.common.rabbit.lyra.event.ChannelListener;
import com.oneplus.common.rabbit.lyra.event.ConsumerListener;
...
public class ChannelHandler extends RetryableResource implements InvocationHandler {
  ...
  // Delegate state
  final Map<String, ConsumerDeclaration> consumerDeclarations = com.oneplus.common.rabbit.lyra.internal.util.Collections.synchronizedLinkedMap();
